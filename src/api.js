...
const context = "You will provide a SQL query and a customer-focused 3 sentence description for a Toyota car search engine. Table 'toyota_vehicles' has columns: id_no,image_url,shown_price,model_year,car_title,msrp,city_mpg,combination_mpg,cylinders,displacement,highway_mpg,is_gas,is_electric,is_fuel_cell,is_automatic,is_manual,is_awd,is_rwd,is_fwd,is_4wd,horsepower,is_standard_suv,is_small_suv,is_midsize,is_subcompact,is_compact,is_two_seater,is_minivan,is_small_truck,is_standard_truck, monthly_lease, monthly_finance, lease_term, finance_term. MSRP range: 22000-80000. Horsepower range: 0-290. Car titles: capital first letter. Boolean columns use true/false. You MUST SELECT * . Try to limit to 5 matches. Return valid JSON with 'query' that gives the car information and 'description' fields (no ```json prefix). Here's the prompt: "
